...
class RegattasController < ApplicationController
  ...
  def regatta_params
    params.require(:regatta).permit(:name, :place, :startdate, :enddate, :supplement, :registration_deadline, :registrated, :early_entry_deadline, :paid, :comment, :fee, user_ids: [])
  end
